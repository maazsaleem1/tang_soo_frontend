...
import 'package:tang_soo_karate/controllers/privacy_policy_controller.dart';
...
class _PrivacyPolicyScreenState extends State<PrivacyPolicyScreen> {
  static const _tag = 'privacy_policy';

  @override
  void initState() {
    super.initState();
    Get.put(PrivacyPolicyController(), tag: _tag);
  }

  @override
  void dispose() {
    Get.delete<PrivacyPolicyController>(tag: _tag);
    super.dispose();
  }

  @override
  Widget build(BuildContext context) {
    final c = Get.find<PrivacyPolicyController>(tag: _tag);
    ...
    return Scaffold(
      ...
      body: Obx(() {
        if (c.isLoading.value) {
          return const _PrivacyLoadingShimmer();
        }
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              styledText('Privacy Policy', TextType.font20700),
              14.verticalSpace,
              Html(
                data: html,
                style: {
...
class _PrivacyLoadingShimmer extends StatelessWidget {
  const _PrivacyLoadingShimmer();
